                                ...
                                <div class="col-md-10 col-sm-11 display-table-cell v-align">
                                    <div class="user-dashboard">
                                        <div class="row">
                                            ...
                                            <!-- INICIO DE CONTEÚDO  -->
                                            <a href="/UsuarioServlet"><button type="button"
                                                    class="buttonYellow">Usuário</button></a>
                                            <!-- Texto Título -->
                                            <div class="w-100">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="#" data-toggle="modal"
                                                                        data-target="#modalChamado<c:out value="
                                                                        ${chamado.id}" />">
                                                                    <button type="button"
                                                        ...
                                                        <c:forEach var="chamados"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" data-toggle="modal"
                                                                        data-target="#chamadoModal<c:out value="
                                                                        ${chamados.idChamado}" />"><button type="button"
                                                                        class="btn btn-link btn-sm btn-rounded">
                                                                        Detalhes
                                                                    </button></a>
                                                                </td>
                                        ...
                                        <c:forEach var="chamados" items="${requestScope.chamados}">
                                            <div class="modal fade" id="chamadoModal" data-bs-backdrop="static"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <label for="message-text"
                                                                                class="col-form-label">Descrição do
                                                                                Local</label>
                                                                            <textarea class="form-control text-bg-light"
                                                                            name="descricaoLocal" value="<c:out value="${chamados.descricaoLocal}"/> " readonly="readonly" /></textarea>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <label for="message-text"
                                                                                ...
                                                                                Problema</label>
                                                                            <textarea class="form-control text-bg-light"
                                                                            name="descricaoProblema" value="<c:out value="${chamados.descricaoProblema}"/> " readonly="readonly" /></textarea>
                                                                        </div>
