                ...
                <%--Validar se usuário está logado--%>
                    ...
                    <head>
                        ...
                        <%@include file="header.jsp" %>
                                ...
                                <div class="row display-table-row">
                                    ...
                                    <div class="table-secondary table-sm p-3">
                                        <table class="table align-middle mb-0 bg-white table-hover p-3">
                                            ...
                                            <tbody data-bs-toggle="modal" data-bs-target="#chamadoModal<c:out value="
                                                ${chamado.chamado.id}" />">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary"
                                                                ...
                                                                data-bs-target="#chamadoModal<c:out value="
                                                                ${chamado.id}" />">
                                                            Detalhes
                                                            </button>
                                                        </td>
                                            ...
                                            <c:forEach var="chamados" items="${requestScope.listaChamadosDesc}">
                                                <c:if test="${not empty chamados.ordemServicoId}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="fw-normal mb-1">
                                                                <fmt:formatDate value="${chamados.dataHora}"
                                                                    pattern="dd/MM/yyyy - HH:mm:ss" />
                                                            </p>
                                                        </td>
                                                        <td>
                            ...
                            <c:forEach var="chamado" items="${requestScope.listaChamadosAsc}">
                                <div class="modal fade" data-bs-keyboard="false" tabindex="-1"
                                    aria-labelledby="chamadoModalLabel" aria-hidden="true"
                                    id="chamadoModal<c:out value=" ${chamado.id}" />">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control text-bg-light"
                                                            id="recipient-name" value="<c:out value="
                                                            ${chamado.usuarioId.nome}" />" readonly>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control text-bg-light"
                                                            id="campus-name" value="<c:out value="
                                                            ${chamado.predioId.campusId.nome}" />" readonly>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control text-bg-light"
                                                            id="predio-name" value="<c:out value="
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <textarea class="form-control text-bg-light" id="local-text"
                                                            readonly><c:out value="${chamado.descricaoLocal}"/></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <textarea class="form-control text-bg-light" id="problema-text"
                                                            readonly><c:out value="${chamado.descricaoProblema}"/></textarea>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input type="text" class="form-control text-bg-light"
                                                            id="status" value="<c:out value="
                                                            ${chamado.statusId.nome}" />" readonly>
                                                    </div>

                                                    <div class="col-sm-4">
                                                        <label for="recipient-name" class="col-form-label">Ordem de
                                                            Serviço</label>
                                                        <input type="text" class="form-control text-bg-light"
                                                            id="ordem-de-servico" value="Não Associada" readonly>
                                                    </div>

                                                    <div class="col-sm-4">
                                                        <label for="recipient-name" class="col-form-label">Data e
                                                            Hora</label>
                                                        <input type="text" class="form-control text-bg-light" id="Data"
                                                            pattern="dd/MM/yyyy - HH:mm:ss"
                                                            value="<fmt:formatDate value=" ${chamado.dataHora}"
                                            ...
                                            <div class="row text-left">
                                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#associarModal<c:out value="
                                                        ${chamado.id}" />">Associar</button>
                                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                        data-bs-target="#novaOrdemDeServicoModal<c:out value="
                                                        ${chamado.id}" />">Nova Ordem De Serviço</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="w-50">
                                                        <p class="text-body-secondary" id="chamadoEmAndamentoModal">
                                                            Chamado</p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label for="message-text" class="col-form-label">Comentário
                                                            Operário</label>
                                                        <textarea class="form-control text-bg-light" id="problema-text"
                                                            readonly></textarea>
                                                    </div>
                            ...
                            <c:forEach var="chamado" items="${requestScope.listaChamadosAsc}">
                                <div class="modal fade" id="novaOrdemDeServicoModal<c:out value=" ${chamado.id}" />"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="w-50">
                                                        <p class="text-body-secondary" id="novaOrdemDeServicoModal">Nova
                                                            Ordem de Serviço</p>
                                        ...
                                        <form action="OrdemDeServicoServlet?action=novaOrdemServico" method="POST">
                                            <div class="modal-body">
                                                ...
                                                <input type="text" class="form-control text-bg-light" id="id-chamado"
                                                    name="idChamado" value="<c:out value=" ${chamado.id}" />" hidden>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label for="recipient-name"
                                                                class="col-form-label">Campus:</label>
                                                            <input type="text" class="form-control text-bg-light"
                                                                id="campus-name" name="campus" value="<c:out value="
                                                                ${chamado.predioId.campusId.nome}" />" readonly>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label for="message-text" class="col-form-label">Descrição
                                                                do Local</label>
                                                            <textarea class="form-control text-bg-light" id="local-text"
                                                                name="descricaoLocal"
                                                                required><c:out value="${chamado.descricaoLocal}"/></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <textarea class="form-control text-bg-light"
                                                                id="problema-text" name="descricaoProblema"
                                                                required><c:out value="${chamado.descricaoProblema}"/></textarea>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <c:forEach var="especialidade"
                                                            items="${requestScope.especialidades}">
                                                            <c:if test="${especialidade.nome != 'N/A'}">
                                                                <input type="radio" name="especialidade"
                                                                    value="${especialidade.id}"> ${especialidade.nome}
                                                                <br>
                                                            </c:if>
                                                        </c:forEach>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="recipient-name" class="col-form-label">Digite
                                                                aqui o número da Ordem de Serviço</label>
                                                            <input type="text" class="form-control text-bg-light"
                                                                id="ordem-de-servico" name="numeroOS" required>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <!--********** MODAL ASSOCIAR **************-->
                            <c:forEach var="chamado" items="${requestScope.listaChamadosAsc}">
                                <div class="modal fade" id="associarModal<c:out value=" ${chamado.id}" />"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="w-50">
                                                        <p class="text-body-secondary">Associar à Ordem de Serviço
                                                            Existente</p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label for="recipient-name" class="col-form-label">Ordens de
                                                                Serviço para o mesmo local</label>
                                                        </div>
                                                        <div class="list-group">
                                                            <c:forEach var="ordem" items="${requestScope.ordens}">
                                                                <c:if test="${empty ordem.dataFinalizacao}">
                                                                    <c:forEach var="chamadoOS"
                                                                        items="${requestScope.listaChamadosAsc}">
                                                                        <c:if
                                                                            test="${not empty chamadoOS.ordemServicoId && chamadoOS.predioId eq chamado.predioId}">
                                                                            <span data-bs-placement="right"
                                                                                ...
                                                                                <button
                                                                                    data-bs-target="#ordemDeServico2Modal"
                                                                                    data-bs-toggle="modal" type="button"
                                                                                    class="list-group-item list-group-item-action">#
                                                                                    ${ordem.numeroOS}</button>
                                                                            </span>
                                                                        </c:if>
                                                                    </c:forEach>
                                                                </c:if>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <div class="row text-left">
                                                ...
                                                <div class="col">
                                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                        data-bs-target="#novaOrdemDeServicoModal">Nova Ordem De
                                                        Serviço</button>
                                                </div>
