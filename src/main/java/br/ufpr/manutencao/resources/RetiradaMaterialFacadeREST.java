...
@jakarta.ws.rs.Path("br.ufpr.manutencao.beans.retiradamaterial")
public class RetiradaMaterialFacadeREST extends AbstractFacade<RetiradaMaterial> {
    ...
    @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, RetiradaMaterial entity) {
        super.edit(entity);
    }
    ...
    public RetiradaMaterial find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<RetiradaMaterial> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
